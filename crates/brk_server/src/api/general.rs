        ...
        .api_route(
            ...
            get_with(
                ...
                |op| {
                    op.id("get_prices")
                        .general_tag()
                        .summary("Current LTC price")
                        .description("Returns litecoin latest price (exchange-derived, USD only).\n\n*[Mempool.space docs](https://mempool.space/docs/api/rest#get-price)*")
            ...
            get_with(
                ...
                |op| {
                    op.id("get_historical_price")
                        ...
                        .description("Get historical LTC/USD price. Optionally specify a UNIX timestamp to get the price at that time.\n\n*[Mempool.space docs](https://mempool.space/docs/api/rest#get-historical-price)*")
